...
We will first read in two made-up .csv files; 1) **primates_binary_traits.csv** with presence/absence data for six variables (X1 to X6), and 2) **primates_continuous.csv** with randomly generated continuous data for four variables (X1 to X4).
