...
prset applyto=(1) revmatpr = dirichlet(6 values) statefreqpr =
dirichlet(4 values)  
shapepr = fixed() pinvarpr = fixed(pinvar) tratiopr = fixed(kappa
value);  
prset applyto=(2) revmatpr = dirichlet(6 values) statefreqpr =
dirichlet(4 values)  
shapepr = fixed() pinvarpr = fixed(pinvar) tratiopr = fixed(kappa
value);  
...
unlink shape=(all) pinvar=(all) statefreq=(all) revmat=(all);  
prset applyto=(1) revmatpr=dirichlet(0.4215, 2.3291, 1.0000, 0.4215,
2.3291, 1.0000) pinvarpr = fixed(0.1090);  
prset applyto=(2) revmatpr=dirichlet(0.5943, 1.4398, 1.0000, 0.5943,
3.0841, 1.0000) statefreqpr=dirichlet(0.2516, 0.2276, 0.3115, 0.2093)
shapepr=fixed(0.4520);  
prset applyto=(3) revmatpr=dirichlet(0.5639, 1.2359, 1.0000, 0.5639,
2.6979, 1.0000) statefreqpr=dirichlet(0.2630, 0.2073, 0.3064, 0.2233)
